...
namespace Loggel_Test.Processors
{
  ...
  public class AndProcessor
  {
    ...
    public void Initialise()
    {
      ...
      m_and.ConnectedProcessor = maths;
    ...
    public void And_ConditionsMet()
    {
      ...
      Circuit compareValue2 = ComponentFactory.CreateCircuit( "", 456 );
    ...
    [TestMethod]
    public void And_ConditionsNotMet()
    {
      Circuit compareValue1 = ComponentFactory.CreateCircuit( "", 123 );
      compareValue1.Context.Value = 123;
      And.Condition condition1 = new And.Condition();
      condition1.ValueSource = compareValue1.Context;
      condition1.ComparisonValue = 123;
      condition1.ComparisonType = ValueComparison.Comparison.EQUAL;
